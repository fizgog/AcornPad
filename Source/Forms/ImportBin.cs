...
{
    public partial class ImportBin : Form
    {
        ...
        /// <param name="e"></param>
        private void ImportBin_Load(object sender, EventArgs e)
        {
        ...
        private void ButtonLoad_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.OK)
            {
                ...
                if (frm.ShowDialog() == DialogResult.OK)
                {
                    ...
                    MachineType machineType = frm.GetMachine.MachineType == "Acorn Atom" ? MachineType.Atom : MachineType.BBC;
                    Machine machine = frm.GetMachine;
                    Palette palette = new Palette(machineType, frm.GetMachine.NumColours);

                    ImageBox1.Load(machineType, machine, palette, buffer);
